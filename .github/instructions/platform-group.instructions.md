...
- **Platform-level** — `pt-ai-context/.github/instructions/platform-group.instructions.md` (this file)
- **Team-level** — `pt-*-ai-context/.github/instructions/<team>-team.instructions.md` (one per team)
